...
mat_location = [ file_location ];

flag_save = 0;

% for i_subject = [0]  SubjectName = '14gratings316'; YMIN = 40; YMAX = 90;
for i_subject = [12]  SubjectName = ['grating' num2str(i_subject, '%0.2d')]; YMIN = 20; YMAX = 100;
    ...
    jpg_file_name = [ file_location '/IITT_' file_load([4:end]) '___'];
